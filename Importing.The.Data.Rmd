...
```{r}
prepareForCorrelationMatrix(file = "Data/cohort.h5", studyID = "Bacteriosins", rows = "Genes", columns = "Genera", rowChunk = 50e3, colChunk = 1000, compressionLevel = 9)
correlateEntities(file = "Data/cohort.h5", studyID = "Bacteriosins", rows = "Genes", columns = "Genera", verbose = TRUE, nRows = 50e3, nCols = 1000)
```